  ...
  public: {
    Tables: {
      ...
      congresso_presencas: {
        ...
        Relationships: [
          {
            foreignKeyName: "congresso_presencas_congresso_id_fkey"
            columns: ["congresso_id"]
            isOneToOne: false
            referencedRelation: "congressos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "congresso_presencas_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      congresso_programacao: {
        ...
        Relationships: [
          {
            foreignKeyName: "congresso_programacao_congresso_id_fkey"
            columns: ["congresso_id"]
            isOneToOne: false
            referencedRelation: "congressos"
            referencedColumns: ["id"]
