  ...
  if (loading) {
    return (
      <View style={s.screen}>
        ...
        {renderHeader()}
        {/* Skeleton espelhando o layout real (hero + ações + cards) */}
        <View style={sk.hero}>
          <View style={[sk.block, { width: 96, height: 26, borderRadius: 999 }]} />
          <View style={[sk.block, { width: '82%', height: 24, marginTop: 12 }]} />
          <View style={[sk.block, { width: '55%', height: 24, marginTop: 8 }]} />
        </View>
        <View style={s.body}>
          <View style={s.actions}>
            <View style={[sk.block, { flex: 1, height: 58, borderRadius: 18 }]} />
            <View style={[sk.block, { width: 58, height: 58, borderRadius: 18 }]} />
          </View>
          <View style={s.card}>
            <View style={[sk.block, { width: '40%', height: 12 }]} />
            <View style={[sk.block, { width: '68%', height: 15, marginTop: 8 }]} />
            <View style={s.divider} />
            <View style={[sk.block, { width: '35%', height: 12 }]} />
            <View style={[sk.block, { width: '55%', height: 15, marginTop: 8 }]} />
          </View>
          <View style={s.card}>
            <View style={[sk.block, { width: '45%', height: 14, marginBottom: 14 }]} />
            <View style={[sk.block, { width: '100%', height: 12 }]} />
            <View style={[sk.block, { width: '96%', height: 12, marginTop: 8 }]} />
            <View style={[sk.block, { width: '78%', height: 12, marginTop: 8 }]} />
          </View>
        </View>
      </View>
    );
...
const s = StyleSheet.create({
  ...
  subscribed: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, height: 58, borderRadius: 18, backgroundColor: SHEET.successTint, borderWidth: 1, borderColor: SHEET.success },
  subscribedText: { color: SHEET.success, fontSize: 15, fontWeight: '800' },
...
const sk = StyleSheet.create({
  hero: { height: HERO_HEIGHT, backgroundColor: SHEET.bgDeep, justifyContent: 'flex-end', padding: 16 },
  block: { backgroundColor: SHEET.glass, borderRadius: 8, borderWidth: 1, borderColor: SHEET.border },
});
